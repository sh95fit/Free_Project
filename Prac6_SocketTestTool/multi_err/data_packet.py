...
def send_data(ip_addr, port, modem, type, mppt, err, com, count):
  ...
  err_status = {"00":"0000", "01":"0002", "02":"0004", "03":"0008", "04":"0010", "05":"0020", "06":"0040", "07":"0080", "08":"0100", "09":"0200", "10":"0400", "11":"0800", "12":"1000", "13":"0101", "14":"0141", "15":"000B"}
  ...
  pre_set_lte = f"011111111111111111111111111111111111111111{station_num}1401{type_status[type]}{station_num}{com_status[com]}"
  end_set = f"xxxxxxxxxxxxxxxx{err_status[err]}"
