...
def send_data(ip_addr, port, modem, type, mppt, err, com):
  ...
  pre_set_lora = f"1401{type_status[type]}0{station_num}{com_status[com]}"
  pre_set_lte = f"01xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxyy1401{type_status[type]}0{station_num}{com_status[com]}"
